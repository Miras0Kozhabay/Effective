Окей, давай коротко и внятно оформим **README.md** для твоего проекта с текущим функционалом, плюс отметим возможность фильтров и сортировки, чтобы показать, что ты умеешь добавлять фичи. Вот пример:
